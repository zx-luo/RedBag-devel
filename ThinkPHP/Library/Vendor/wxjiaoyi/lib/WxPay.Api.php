...
class WxPayApi
{
	...
	public static function unifiedOrder($inputObj, $timeOut = 60)
	{
		...
		$inputObj->SetAppid(WXAPPID);//公众号appID
	...
	{		
		...
		if($useCert == true){
			...
			curl_setopt($ch,CURLOPT_SSLCERT,WXCERTPATH.'Uploads/wxcacert/apiclient_cert.pem');
			curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');
			curl_setopt($ch,CURLOPT_SSLKEY, WXCERTPATH.'Uploads/wxcacert/apiclient_key.pem');
		}
		//post提交方式
