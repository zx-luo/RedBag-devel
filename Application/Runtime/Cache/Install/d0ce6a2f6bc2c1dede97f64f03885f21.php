...
<div class="wrap">
  ...
  <div class="bottom text-center"><img src="/Public/Install/image/loading.gif" /><font color="#1abc9c"> 正在安装...</font></div>
  <script type="text/javascript">
		function showmsg(content,status){
			var icon = '<i class="fa-rig"> '+content+' </i> ';
			if(status == "error"){
				icon = '<i class="fa-err"> '+content+' </i> ';
			}
			$('#loginner').append("<li>"+icon+"</li>");
